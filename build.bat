...
C:\Users\ant_t\Dropbox\C64\[Software]\WinVICE-3.0-x64\c1541 -format c64-studio,666 d64 c64-studio.d64 -attach c64-studio.d64 -write c64-studio.prg c64-studio.prg -write c64-browser.prg c64-browser.prg -write assets\c64-1351.mou c64-1351.mou -write assets\c64-reu.emd c64-reu.emd -write assets\c64-hi.tgi c64-hi.tgi -write assets\litt.tch litt.tch -write assets\logo.stl logo.stl -write assets\monkey.stl monkey.stl
